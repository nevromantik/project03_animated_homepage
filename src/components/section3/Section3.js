    ...
    <div className="section3_wrap">
      ...
      >
        ...
        <p className="section3_box_p">
          Elit ut aliquam purus sit amet luctus venenatis. <br /> Ridiculus mus
          mauris vitae ultricies leo integer <br /> malesuada. Massa enim nec
          dui nunc mattis <br />
          enim. Sagittis vitae et leo duis ut. Lacus <br /> suspendisse faucibus
          interdum.
        </p>
